...
UniversalAnalyticsPlugin.prototype.get = function (name, success, error) {
  cordova.exec(success, error, 'UniversalAnalytics', 'getField', [name]);
};

UniversalAnalyticsPlugin.prototype.set = function (name, success, error) {
  cordova.exec(success, error, 'UniversalAnalytics', 'setField', [name]);
};
